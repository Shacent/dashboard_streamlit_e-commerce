...
with st.sidebar:
    st.markdown(
        "<div style='display: flex; justify-content: center;'><h1>Muhammad Hauzan Dini Fakhri</h1></div>",
    ...
    st.markdown(
        ...
        "<img src='https://media.licdn.com/dms/image/D5603AQFcCTJbpar-pg/profile-displayphoto-shrink_200_200/0/1684496315051?e=1706140800&v=beta&t=1czu2jaeQDwJ8ym4Z7OyOqlBbsuaNPZm6JTB6BxhPrg' "
        "width='200' style='border-radius: 50%;'>"
        "</div>",
        unsafe_allow_html=True
    )
    st.write('')
    st.text("Email    : hauzandini@gmail.com")
    st.text("GitHub   : github.com/Shacent")
    st.text("LinkedIn : linkedin.com/in/muhammad-hauzan-dini-fakhri")
